 ...
 *
 * A program that encrypts EXAMPLE.svg, an illustration of
...
FILE *fin;	//EXAMPLE.svg is used as the file to be chewed 
FILE *fot;	//EXAMPLE.svg.chewed is the encrypted file

//Helper variables
static unsigned char mask[] = {128, 64, 32, 16, 8, 4, 2, 1};
static int lockchunk = 64; //could substitute a password
...
int main(int ac, char** av)
{
	...
	fin = fopen("EXAMPLE.svg", "rb");		//read binary
	fot = fopen("EXAMPLE.svg.chewed", "w+");//write
